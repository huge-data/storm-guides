...
public class SearchEngineTopologyStarter {
	...
	public static StormTopology createTopology() {
		...
		builder.setBolt("answer-items-feed", new AnswerItemsFeedBolt()).fieldsGrouping("read-item-data",
				new Fields("origin"));
	...
	public static void main(String[] args) {
		if (args.length < 5) {
			System.err
					.println("Incorrect parameters. Use: <name> <queries-pull-host> <feed-pull-host> <items-api-host> <max-pulling>");
			System.exit(-1);
		}
